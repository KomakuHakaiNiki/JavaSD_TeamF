  ...
  <div class="layout-container">
    ...
    <main class="main-content">
      ...
      <form method="get" action="list"
            class="filter-area mb-4 row gx-3 gy-2 align-items-end">
        <!-- 入学年度 -->
        <div class="col-auto">
          ...
          <select name="entYear" class="form-select">
            ...
            <c:forEach var="y" items="${entYearList}">
              <option value="${y}" <c:if test="${y eq selectedEntYear}">selected</c:if>>
                ${y}
              </option>
            </c:forEach>
          </select>
        ...
        <div class="col-auto">
          ...
          <select name="classNum" class="form-select">
            ...
            <c:forEach var="c" items="${classNumList}">
              <option value="${c}" <c:if test="${c eq selectedClassNum}">selected</c:if>>
                ${c}
              </option>
            </c:forEach>
          </select>
        ...
        <div class="col-auto form-check mt-4">
          <input type="checkbox"
                 ...
                 <c:if test="${selectedAttend}">checked</c:if> />
